				...
				if (user.getPassword().equals(password)) {
					if (user.getRole().equals("Manager")) {
						...
						case 1:
							...
							String productDetail = "the product is "+foodOrder.getList();
							String totalCost= "total cost = "+foodOrder.getTotalcost();
							
							File f = new File("productbill.txt");
							FileWriter fileWriter = null;
							
							try {
							   fileWriter = new FileWriter(f);
							   fileWriter.write(productDetail);
							   fileWriter.write(totalCost); 
